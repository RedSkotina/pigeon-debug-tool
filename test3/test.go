...
var g = &grammar{
	rules: []*rule{
		{
			name: "Test",
			pos:  position{line: 14, col: 1, offset: 142},
			expr: &actionExpr{
				pos: position{line: 14, col: 9, offset: 150},
				run: (*parser).callonTest1,
				expr: &seqExpr{
					pos: position{line: 14, col: 9, offset: 150},
					exprs: []interface{}{
						&litMatcher{
						...
						&labeledExpr{
							pos:   position{line: 14, col: 13, offset: 154},
							label: "s",
							expr: &anyMatcher{
								line: 14, col: 15, offset: 156,
							},
						},
						&litMatcher{
							pos:        position{line: 14, col: 17, offset: 158},
							val:        "]",
							ignoreCase: false,
						},
					},
...
func (c *current) onTest1(s interface{}) (interface{}, error) {
	fmt.Println(string(c.text))
	return "", nil
}

func (p *parser) callonTest1() (interface{}, error) {
	stack := p.vstack[len(p.vstack)-1]
	_ = stack
	return p.cur.onTest1(stack["s"])
}
